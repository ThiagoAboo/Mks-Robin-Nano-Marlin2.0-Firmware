...
#undef IS_LEGACY_TFT
  ...
  #if NONE(TFT_COLOR_UI, TFT_CLASSIC_UI, TFT_LVGL_UI, TFT_LVGL_7_UI)
    #error "TFT_COLOR_UI, TFT_CLASSIC_UI, TFT_LVGL_UI, TFT_LVGL_7_UI is required for your TFT. Please enable one."
  #elif 1 < ENABLED(TFT_COLOR_UI) + ENABLED(TFT_CLASSIC_UI) + ENABLED(TFT_LVGL_UI) + ENABLED(TFT_LVGL_7_UI)
    #error "Please select only one of TFT_COLOR_UI, TFT_CLASSIC_UI, TFT_LVGL_UI or TFT_LVGL_7_UI."
  #endif
#elif ANY(TFT_COLOR_UI, TFT_CLASSIC_UI, TFT_LVGL_UI, TFT_LVGL_7_UI)
...
#if ANY(HAS_TFT_LVGL_UI, HAS_TFT_LVGL_7_UI) && DISABLED(TFT_RES_480x320)
