...
typedef struct _mks_obj_t {
  mks_layout_item_t layout_item;
} mks_obj_t;

typedef void (*mks_layout_cb)(mks_layout_item_t item, lv_obj_t * parent);

extern void mks_clear_disp();
extern void mks_register_rotary_group();
...
extern lv_obj_t * mks_draw_button(const char * name, mks_layout_item_t id, lv_align_t align, lv_coord_t x_ofs, lv_coord_t y_ofs);
extern lv_obj_t * mks_draw_label(const char * msg, lv_align_t alignLabel, lv_align_t alignObj, lv_coord_t x_ofs, lv_coord_t y_ofs);
